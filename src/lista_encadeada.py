...
# lista_compras.inserir_ordenado(OrdemNode('C', 100, 50))
# lista_compras.inserir_ordenado(OrdemNode('C', 120, 30))
# lista_compras.inserir_ordenado(OrdemNode('C', 90, 70))
...
# lista_vendas.inserir_ordenado(OrdemNode('V', 95, 40))
# lista_vendas.inserir_ordenado(OrdemNode('V', 80, 20))
# lista_vendas.inserir_ordenado(OrdemNode('V', 105, 60))
# lista_vendas.exibir()

# print("=== Teste: topo() e is_empty() ===")
# print("Topo das compras:", lista_compras.topo().id, lista_compras.topo().preco)
# print("Lista de compras vazia?", lista_compras.is_empty())

# print("=== Teste: remover(id) - removendo o ID do topo ===")
# id_para_remover = lista_compras.topo().id
# removida = lista_compras.remover(id_para_remover)
# print("Removida:", removida.id, removida.preco)
# lista_compras.exibir()

# print("=== Teste: remover(id) - removendo ID que NÃO existe (999999) ===")
# resultado = lista_compras.remover(999999)
